  ...
  >
    <div class="flex items-center justify-between gap-2">
      <a href="{base}/" class="flex items-baseline gap-1.5">
        <span class="text-lg font-extrabold text-terracota">Go on!</span>
        <span class="hidden text-xs font-medium text-carvao/50 sm:inline">· anglais pour les États-Unis</span>
      </a>
      <div class="flex items-center gap-1">
        ...
        <button
          ...
          aria-label="Rechercher dans le kit"
        ...
        <div class="relative">
          ...
          {#if menuAberto}
            ...
            >
              ...
              >
                <span class="text-lg">🗣️</span> Traducteur Google
              </a>
              <a
                href="{base}/bolso/"
                onclick={() => (menuAberto = false)}
              ...
              >
                <span class="text-lg">💱</span> Poche du voyageur
              </a>
            </div>
          {/if}
        </div>
