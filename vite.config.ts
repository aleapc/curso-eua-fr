...
export default defineConfig({
  plugins: [
    ...
    SvelteKitPWA({
      ...
      manifest: {
        name: 'Go on! — L\'anglais pour survivre aux États-Unis',
        short_name: 'Go on!',
        description: 'Anglais et culture pour survivre aux États-Unis · l\'audio d\'abord, fonctionne hors connexion',
        lang: 'fr',
        theme_color: '#C84B31',
